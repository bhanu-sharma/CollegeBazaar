...
$name=test_input(mysql_real_escape_string($_POST["fullname"]));
...
$branch=test_input(mysql_real_escape_string($_POST["branch"]));
}
...
VALUES ('$name', '$branch', '$semester', '$contact', '$target_file', '$itemname', '$email', '$itembranch', '$itemsemester', '$price', '$description')";
