...
<form action="uploadtodb.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data" name="myform">
...
<div>
  ...
  <div class="container-fluid">
	...
	<br><br>
	Branch:
		<select id="branch" name="branch" placeholder="branch" required> 
...
<!--Data about the item being submitted -->
	...
	<br><br>
	<textarea name="description" rows="5" cols="30" placeholder="Description" id="description">
	</textarea>
	<br><br>
